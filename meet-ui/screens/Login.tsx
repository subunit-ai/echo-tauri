...
/**
 * LOGIN — einmalige Anmelde-Subpage (TJ 2026-06-12): nur fuer Erstnutzer ohne
 * gespeicherten Login/Gast-Flag. Anmelden (SSO) oder „Als Gast fortfahren".
 ...
 */
export function Login({ onLogin, onGuest }: { onLogin: () => void; onGuest: () => void }) {
  const { t } = useI18n();
  const m = useMeeting();
